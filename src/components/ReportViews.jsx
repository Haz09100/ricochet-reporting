...
function LiveOwnershipReport({ data }) {
  ...
  const cards = [["Qualified live leads",totals.live_leads,"First live date + formal note + sent email"],["Live transfers",totals.live_transfers,"Original 2.3 disposition"],["Live call backs",totals.live_call_backs,"Original 2.4 disposition"],["Live group texts",totals.live_texts,"Original 2.5 disposition"],["Ownership confirmed",totals.confirmed_ownership,"Formal-note owner matches form ISA"],["Needs review",totals.needs_review,"Missing or conflicting note owner / ISA"]];
  const auditCards = [["Old-style current live",reconciliation.current_live_activity,"Current live status active in range"],["Previously live reworked",reconciliation.prior_live_reworked,"First live date is before range"],["First live in range",reconciliation.first_live_in_range,"Permanent monthly anchor"],["Missing sent email",reconciliation.missing_live_email,"Stopped by email gate"],["Missing qualifying note",reconciliation.missing_formal_note,"No timely formal note with 2.3, 2.4, or 2.5"],["Final qualified",reconciliation.selected_qualified,"After all selected filters"]];
